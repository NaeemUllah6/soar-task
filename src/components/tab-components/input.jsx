    ...
    <div className="flex flex-col gap-2">
      ...
      {inputType === 'select' ? (
        ...
        <input
          ...
          maxLength={Length}
          className="block w-full h-[50px] rounded-[15px] px-3 py-2 placeholder:text-[#718EBF] text-[#718EBF] text-[15px] bg-white border border-gray-300  shadow-sm focus:outline-none focus:ring-black focus:border-black sm:text-sm"
        />
      )}
    </div>
  );
