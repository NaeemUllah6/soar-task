      ...
      {isModalOpen && (
        ...
        >
          <div className="relative p-4 w-full max-w-2xl max-h-full ">
            <div className="relative bg-white rounded-lg shadow-button-shadow dark:bg-gray-700">
              {/* Modal Header */}
                  ...
                  {carousel.map((carousel1, index) => (
                    <div key={index} className="flex flex-col gap-[15px]">
                      ...
                      <div className="text-center">
                        ...
                        <p className={`text-[15px] font-inter font-[400] text-[#718EBF] ${index === 0 ? "font-bold" : "font-[400]"}`}>
                          {carousel1.avatarDes}
