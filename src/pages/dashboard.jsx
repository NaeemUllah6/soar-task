            ...
            <div className='p-[18px] w-full lg:p-[35px] bg-white rounded-3xl mt-[18px] h-full'>
              ...
              <form onSubmit={handleSubmit} className='mt-[30px]' action="">
                <div className='flex  items-center w-full gap-2'>
                  <div className='w-[150px]'><label className='font-[400] text-[16px] text-[#718EBF]' htmlFor="amount">Write Amount</label></div>
                  <div className='relative w-full'>
                    <input required className=' w-full border-none px-[30px] py-[15px] bg-[#EDF1F7] placeholder:text-[#718EBF] focus:outline-none h-[50px] focus:ring-gray-50 rounded-[50px]' id="amount" type="text" placeholder='525.50' />
